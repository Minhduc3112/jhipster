...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_REGION),
          REQUEST(ACTION_TYPES.UPDATE_REGION),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_REGION),
          REQUEST(ACTION_TYPES.DELETE_REGION),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_REGION),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_REGION actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_REGION),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_REGION),
          payload: resolvedObject,
        },
      ];
