...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_TASK),
          REQUEST(ACTION_TYPES.UPDATE_TASK),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_TASK),
          REQUEST(ACTION_TYPES.DELETE_TASK),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_TASK),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_TASK actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_TASK),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_TASK),
          payload: resolvedObject,
        },
      ];
